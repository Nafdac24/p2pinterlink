...
const Hero = () => {
  return (
    <section className="relative w-full min-h-[600px] flex items-center overflow-hidden">
      ...
      <div className="h-2 w-2 bg-green-600 rounded-full absolute top-6 right-4 md:top-10 md:right-10"></div>
      ...
      <div className="relative z-10 w-full px-6 md:px-16 lg:px-24 max-w-7xl mx-auto">
        <div className="max-w-3xl">
          ...
          <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold leading-tight md:leading-tight lg:leading-tight mb-8">
            Activating Marketplace on your Interlink wallet allows you to
            securely trade your ITG assets with other, using Interlink Escrow
            services
          </h1>
          ...
          <Link
            to="/manage-wallets"
            className="inline-flex items-center gap-2 bg-white rounded-full px-4 py-2 md:px-5 md:py-2.5 mb-8 shadow-lg"
          >
          ...
          <div>
            <Link
              to="/wallet"
              className="bg-[#1A1A1A] text-white px-8 py-3 md:px-10 md:py-4 rounded-full text-sm md:text-base font-medium hover:bg-black transition"
            >
              Download
            </Link>
          </div>
